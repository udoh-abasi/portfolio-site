...
const Projects = () => {
  return (
    <section
      id="projects"
      className="px-4 py-16 mt-24 flex justify-center items-center scroll-mt-[100px]"
    >
          ...
          <figcaption>
            <div className="min-[500px]:flex justify-between">
              <Link
                ...
                target="_blank"
                rel="nofollow"
                class="flex-[0_1_200px] mb-4 min-[500px]:mb-0 relative flex items-center justify-center px-10 py-5 overflow-hidden font-medium text-[var(--special-text-color)]  transition duration-300 ease-out border-2 border-[var(--special-text-color)]  rounded-full shadow-md group"
              >
              ...
              <Link
                ...
                target="_blank"
                rel="nofollow"
                class="flex-[0_1_200px] relative flex items-center justify-center px-10 py-5 overflow-hidden font-medium text-[var(--special-text-color)]  transition duration-300 ease-out border-2 border-[var(--special-text-color)]  rounded-full shadow-md group"
              >
                <span className="absolute inset-0 flex items-center justify-center w-full h-full text-[rgb(var(--nav-bg-color))] duration-300 -translate-x-full bg-[var(--special-text-color)]  group-hover:translate-x-0 ease">
                  <svg
                    className="w-6 h-6"
            ...
            <p className="mt-2">
              ...
              post. Readers can also visit and read inciting contents. They can
              also like, and comment at will.
            </p>
